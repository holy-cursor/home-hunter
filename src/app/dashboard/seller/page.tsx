            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <Link
                        ...
                        className="bg-indigo-600 hover:bg-indigo-700 rounded-xl p-6 text-white shadow-md transition-all flex flex-col justify-between group"
                    >
                        <div className="flex items-center justify-between mb-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                        <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center">
                            ...
                            <Link href="/dashboard/seller/add" className="text-sm text-indigo-600 font-medium hover:text-indigo-700">
                                + Add New
                            </Link>
                        </div>
                                    ...
                                    <div key={listing.id} className="px-6 py-4 hover:bg-slate-50 transition-colors group">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="text-right mr-4">
                                                <p className="text-sm font-bold text-indigo-600">₦{listing.price.toLocaleString()}</p>
                                            </div>
                                            <button
                                    ...
                                    <div key={chat.id} className="px-6 py-4 hover:bg-slate-50 transition-colors">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <div className="h-10 w-10 rounded-full bg-emerald-100 flex items-center justify-center overflow-hidden border border-emerald-200">
                                                    {chat.buyer?.profilePic ? (
                                                        ...
                                                        <span className="text-emerald-700 font-bold text-xs">{chat.buyer?.name?.[0]}</span>
                                                    )}
                                                </div>
                                                <div>
                                            ...
                                            <Link
                                                ...
                                                className="px-3 py-1.5 bg-white border border-slate-200 text-slate-700 hover:border-emerald-500 hover:text-emerald-600 rounded-lg text-xs font-medium transition-all"
                                            >
                                                Chat
                                            </Link>
                                        </div>
