...
export default function SellerChat() {
    ...
    if (!currentChat || !buyer) return <div className="p-8 text-center text-[#002147]">Chat not found</div>;
                    ...
                    <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-full bg-[#002147] flex items-center justify-center overflow-hidden border-2 border-[#FFC72C]">
                            {buyer.profilePic ? (
                                ...
                                <span className="flex h-full w-full items-center justify-center font-bold text-white">{buyer.name[0]}</span>
                            )}
                        </div>
                        <div>
                            <h2 className="font-bold text-[#002147] leading-tight">{buyer.name}</h2>
                            {listing && (
